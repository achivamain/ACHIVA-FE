      ...
      <div className="w-full">
        <div className="flex gap-2.5 items-center py-2.5 px-5 sm:px-0">
          <div className="flex gap-2.5 items-center">
            <div className="aspect-square w-8 rounded-full bg-loading animate-pulse" />
            <p className="w-25 h-6 bg-loading rounded-sm animate-pulse" />
          </div>
          <button className="ml-auto px-0.5">
            <svg
              width="21"
              height="4"
              viewBox="0 0 21 4"
        ...
        <div className="w-full aspect-square bg-loading animate-pulse" />
        <CheerBtnsSkeleton />
      </div>
    </>
  );
